...
def get_default_settings() -> Settings:
    ...
    return Settings(
        ...
        browser_model_provider=get_default_value("browser_model_provider", "bedrock"),
        browser_model_name=get_default_value("browser_model_name", "us.anthropic.claude-haiku-3-5-20241022-v1:0"),
