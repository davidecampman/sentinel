    ...
    try {
      ...
      if (data.success && data.tunnel_url) {
        ...
        if (this.tunnelLink !== data.tunnel_url) {
          this.tunnelLink = data.tunnel_url;
          localStorage.setItem("sentinel_tunnel_url", data.tunnel_url);
        }
        this.linkGenerated = true;
        ...
        const storedTunnelUrl = localStorage.getItem("sentinel_tunnel_url");
        ...
        if (storedTunnelUrl) {
          ...
          if (verifyData.success && verifyData.is_valid) {
            ...
            // Clear stale URL
            localStorage.removeItem("sentinel_tunnel_url");
            this.tunnelLink = "";
    ...
    try {
      ...
      if (!hasAuth) {
        const proceed = confirm(
          "WARNING: No authentication is configured for your Sentinel instance.\n\n" +
            "Creating a public tunnel without authentication means anyone with the URL " +
            "can access your Sentinel instance.\n\n" +
